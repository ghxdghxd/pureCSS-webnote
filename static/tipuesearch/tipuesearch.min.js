...
{if(i==0){out+='<div class="tipue_search_result note-item-selected">';}else{out+='<div class="tipue_search_result">';}out+='<div class="tipue_search_content_title"><a href="'+found[i].url+'"'+tipue_search_w+'>'+found[i].title+'</a></div>';if(set.debug)
